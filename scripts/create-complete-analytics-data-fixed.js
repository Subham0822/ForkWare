...
async function createCompleteAnalyticsDataFixed() {
  try {
    console.log("🚀 Creating complete analytics data (Fixed Version)...");
    console.log("====================================================");
    ...
    for (const profile of organizerProfiles) {
      ...
      if (profileError) {
        console.log(
          `⚠️  Profile ${profile.organization}: ${profileError.message}`
        );
      } else {
        console.log(`✅ Profile: ${profile.organization}`);
      }
    }
...
createCompleteAnalyticsDataFixed();
